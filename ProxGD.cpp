...
Result ProxGD_one_step(string fmode, string hmode, string tmode, SparseMatrix<double> A, MatrixXd b, MatrixXd x0, double mu, double epsilon, double gamma, int M)
{
