...
{
	// 问题中的f(x)，fmode表示选择何种函数，A和b是f的参数，x是函数自变量，返回函数值result
...
{
	// 问题中的f(x)的梯度，fmode表示选择何种函数，A和b是f的参数，x是函数自变量，返回梯度result

	MatrixXd result = x;
	if (fmode == 1)
	{
		// Frobenious范数平方除以2的梯度
...
*/
>>>>>>> bc11f4023a72f40ead8c9598b61749759e63271b
