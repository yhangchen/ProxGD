...
u = load("results/Frob_L_12_BB_x0.csv");
mu = 1e-2;
l = 4;
...
for i = 1: L
    ...
    fprintf("CVX-Mosek-" + mode +...
        ": cpu: %5.2f, iter: %5d, optval: %6.5E, sparisity: %4.3f,err-to-exact: %3.2E.\n",...
        t_lst(i), iter_lst(i), out_lst(i), sparisity(...
